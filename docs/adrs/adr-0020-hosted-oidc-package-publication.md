# ADR-0020: Hosted OIDC package publication
...
The previous `ai-game` release job selected self-hosted infrastructure and
...
`Plasius-LTD`, repository `ai-game`, workflow `cd.yml`, environment
